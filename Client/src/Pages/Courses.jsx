      ...
      <div className='bg-dark     d-flex  container h-auto w-auto h-50 flex-wrap text-white' >
        ...
        {course.map((curElem, index) => {
          return (
            ...
            <div key={index} className="cardlist    mb-3 mt-5  w-25 h-75     rounded  ms-5 bg-transparent  text-light " >
              ...
              <div className="card-body h-50">
                ...
                <p className='description w-auto text-secondary'>{curElem.createdBy}</p>
                <p className=' text-primary'>{curElem.description}</p>
                {user && user.razorpay_order_id?.status === "active" ? (
                  ...
                  <div className='mb-1'>
                    ...
                    <p className=' text-decoration-line-through'>1000</p> 
